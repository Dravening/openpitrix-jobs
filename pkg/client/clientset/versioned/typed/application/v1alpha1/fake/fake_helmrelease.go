...
var helmreleasesResource = schema.GroupVersionResource{Group: "application.d3os.io", Version: "v1alpha1", Resource: "helmreleases"}

var helmreleasesKind = schema.GroupVersionKind{Group: "application.d3os.io", Version: "v1alpha1", Kind: "HelmRelease"}
